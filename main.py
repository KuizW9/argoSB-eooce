...
UUID = os.environ.get('UUID', 'aca4e9de-9705-428c-a8f2-3c34938dc62c')  # UUID for cross-platform v1 nezha
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'app-py.alvgw.xyz')          # Argo fixed tunnel domain, leave empty for temporary tunnel
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNjQ1MTEzYmM3MWQ0MDgwMzA2ZmFmMWJhMmYyZmM4MGEiLCJ0IjoiMWEwMjRhODEtZGMwYy00MjNjLWEzMGYtNDJjOTQ2NGY4NDc3IiwicyI6IlkyVmpaRFV6TWpVdFpqa3pOUzAwTnprMkxUZzBOemN0T0RKaE0yRmhPREpsTWpFMCJ9')              # Argo fixed tunnel token or json, leave empty for temporary tunnel
ARGO_PORT = int(os.environ.get('ARGO_PORT', '7005'))     # Argo fixed tunnel port
TUIC_PORT = int(os.environ.get('TUIC_PORT', '7002'))         # Tuic5 port
HY2_PORT = int(os.environ.get('HY2_PORT', '7003'))           # Hysteria2 port
REALITY_PORT = int(os.environ.get('REALITY_PORT', '7004'))   # Reality port
CFIP = os.environ.get('CFIP', 'www.visa.com.tw')         # Preferred domain or IP
...
FRP_IP = os.environ.get('FRP_IP', 'n2p.alvgw.xyz')                    # frp 服务端共公网ip
        ...
        "inbounds": [
            {
                ...
                "transport": {
                    "type": "ws",
                    "path": "aca4e9de-9705-428c-a8f2-3c34938dc62c-vm",
                    "max_early_data":2048,
